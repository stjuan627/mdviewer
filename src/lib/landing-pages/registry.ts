...
import { homeLandingPageFr } from '@/lib/landing-pages/fr/home';
import { markdownToHtmlLandingPageFr } from '@/lib/landing-pages/fr/markdown-to-html';
import { markdownToImageLandingPageFr } from '@/lib/landing-pages/fr/markdown-to-image';
import { markdownToPdfLandingPageFr } from '@/lib/landing-pages/fr/markdown-to-pdf';
...
import { homeLandingPageDe } from '@/lib/landing-pages/de/home';
import { markdownToHtmlLandingPageDe } from '@/lib/landing-pages/de/markdown-to-html';
import { markdownToImageLandingPageDe } from '@/lib/landing-pages/de/markdown-to-image';
import { markdownToPdfLandingPageDe } from '@/lib/landing-pages/de/markdown-to-pdf';
...
export const landingPageConfigs: Record<Locale, Record<LandingPageConfig['slug'], LandingPageConfig>> = {
  ...
  fr: {
    home: homeLandingPageFr,
    'markdown-to-html': markdownToHtmlLandingPageFr,
    'markdown-to-image': markdownToImageLandingPageFr,
    'markdown-to-pdf': markdownToPdfLandingPageFr,
  },
  es: {
  ...
  de: {
    home: homeLandingPageDe,
    'markdown-to-html': markdownToHtmlLandingPageDe,
    'markdown-to-image': markdownToImageLandingPageDe,
    'markdown-to-pdf': markdownToPdfLandingPageDe,
  },
  'zh-cn': {
